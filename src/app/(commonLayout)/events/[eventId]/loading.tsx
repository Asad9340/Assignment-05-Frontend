  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] px-4 py-10 sm:py-16">
      <div className="mx-auto w-full max-w-5xl sm:px-6 lg:px-8">
        ...
        <div className="mt-2 h-9 w-1/2 animate-pulse rounded-xl bg-slate-200" />
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_340px]">
            ...
            <div className="mt-8 space-y-4">
              ...
              {Array.from({ length: 3 }).map((_, i) => (
                ...
                >
                  ...
                  <div className="mt-1 h-4 w-4/5 animate-pulse rounded bg-slate-100" />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 h-10 w-full animate-pulse rounded-lg bg-slate-200" />
            </div>
