export default function GlobalLoading() {
  return (
    <main className="min-h-screen bg-[#090f20] px-4 py-16 sm:py-24">
      {/* Hero skeleton */}
      <section className="relative overflow-hidden border-b border-white/10 bg-[#0b1329] px-4 py-20">
        <div className="mx-auto grid w-full max-w-7xl gap-10 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div className="space-y-5">
            ...
            <div className="h-10 w-4/5 animate-pulse rounded-xl bg-white/10" />
            <div className="h-10 w-3/5 animate-pulse rounded-xl bg-white/10" />
          ...
          <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-6">
            ...
            <div className="mt-6 h-10 w-28 animate-pulse rounded-lg bg-white/10" />
          </div>
        </div>
      </section>

      {/* Stats skeleton */}
      <section className="bg-[#090f20] px-4 py-14">
